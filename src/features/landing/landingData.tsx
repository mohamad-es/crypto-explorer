    ...
    cards: [
      {
        ...
        description:
          "Cryptocurrencies operate on decentralized networks, eliminating the need for intermediaries like banks.",
      },
      {
        icon: <ShieldIcon />,
        title: "Anonymity and Privacy",
        description:
          "Cryptocurrencies offer varying levels of privacy, allowing users to transact without revealing personal information.",
      },
      {
        icon: <CryptoIcon />,
