...
const CryptoColumnCard = ({data, cryptoName}: CryptoColumnCardProps) => {
    return (
        <div
            className={'rounded-2xl py-4.5 flex flex-col border border-light-grey bg-white dark:text-light-title dark:bg-main/20 dark:border-light-grey/5 cursor-pointer transition-all hover:shadow-xl'}>
            <div
