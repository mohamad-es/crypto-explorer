...
const CryptoRowCardItems = ({data}: CryptoRowCardProps) => {
    ...
    return (
        <div
            ...
            <div
                ...
                {data.SPOT_MOVING_24_HOUR_CHANGE_PERCENTAGE_USD.toString().charAt(0) === '-' ?
                    ...
                    <ArrowDown02Icon size={18}/>
                        {Number(data.SPOT_MOVING_24_HOUR_CHANGE_PERCENTAGE_USD).toFixed(2)}%</span> :
            ...
            <div
                className={'col-span-2'}>{numberSeparator(Number(data.SPOT_MOVING_24_HOUR_QUOTE_VOLUME_DIRECT_USD).toFixed(2))}</div>
