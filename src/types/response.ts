...
type THistoricalPriceResponse = {
  ...
  TOTAL_CLOSED_PULL_REQUESTS: number;
};

export type {
  TResponse,
  TTopListSearchParams,
  THistoricalPriceParams,
  THistoricalPriceResponse,
  TMetaDataResponse,
  TCryptoResponse,
  TTopListParams,
  TTopListResponse,
